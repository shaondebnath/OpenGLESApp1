...
void SDNCube::Cube_setupGL(double width, double height)
{
	// Initialize GL state.
	glDisable(GL_DITHER);
...
void SDNCube::Cube_tearDownGL()
{
}

void SDNCube::Cube_update()
{
	_rotation += 1.f;

}
void SDNCube::Cube_prepare()
{
	glClear(GL_COLOR_BUFFER_BIT | GL_DEPTH_BUFFER_BIT);
}

void SDNCube::Cube_draw()
{
